            ...
            <div id='form-contact'>
                ...
                <div id='form-contact-block-info'>
                    <div id='block-one-contact'>
                        <p>Имя</p>
                        <input id="first-thrid" type="text" placeholder="Имя"/>
                    </div>
                    <div id='block-two-contact'>
                        <p>Телефон</p>
                        <input id="first-thrid" type="text" placeholder="+7 (999) 999 99-99"/>
                    </div>
                    <div id='block-three-contact'>
                        <p>E-mail</p>
                        <input  id="first-thrid" type="text" placeholder="your@email.ru"/>
                    </div>
                    <div id='block-four-contact'>
                        <p>Сообщение</p>
                        <textarea id="more-message" placeholder="Расскажите о вашем проекте.."/>
                    </div>
