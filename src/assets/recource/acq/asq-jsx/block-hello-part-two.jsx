...
import '../acq-css/block-hello-part-two.css'
        ...
        return(
            <div id="block-hello-part-two">
                    <p id="text-demo">Мы — команда профессионалов из Богородска,
                        ...
                        Наша цель — предлагать решения,
                        которые действительно работают и приносят
                        ощутимый результат нашим клиентам.
